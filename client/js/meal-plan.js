...
class MealPlanManager {
  ...
  async updateDashboardStats() {
    try {
      ...
      // Note: totalExpense, jajanCount, and shoppingCount are now handled by app.js
      // to avoid conflicts and ensure consistency. This function only updates meal plan count.
      console.log("📊 Dashboard stats updated - meal plan count only (expense data handled by app.js)");
